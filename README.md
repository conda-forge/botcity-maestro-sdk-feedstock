About botcity-maestro-sdk-feedstock
===================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/botcity-maestro-sdk-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/botcity-maestro-sdk-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add botcity-maestro-sdk
# for installing globally
pixi global install botcity-maestro-sdk
```
...
It is possible to list all of the versions of `botcity-maestro-sdk` available on your platform:
...
```
pixi search botcity-maestro-sdk --channel conda-forge
```
